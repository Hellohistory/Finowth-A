...
# 新浪财经-科创板股票历史行情数据
@router.post("/stock_zh_kcb_daily")
def get_stock_zh_kcb_daily(request: StockDailyRequest):
    """
    描述: 新浪财经-科创板股票历史行情数据
...
# 东方财富-科创板报告数据
@router.post("/stock_zh_kcb_report_em")
def get_stock_zh_kcb_report_em(request: StockReportRequest):
    """
    描述: 东方财富-科创板报告数据
